...
public class User extends TableImpl<UserRecord> {
    ...
    /**
     * The reference instance of <code>credential.user</code>
     */
    ...
    /**
     * The column <code>credential.user.id</code>.
     */
    public final TableField<UserRecord, Long> ID = createField(DSL.name("id"), SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>credential.user.username</code>.
     */
    public final TableField<UserRecord, String> USERNAME = createField(DSL.name("username"), SQLDataType.VARCHAR.nullable(false), this, "");

    /**
     * The column <code>credential.user.password</code>.
     */
    public final TableField<UserRecord, String> PASSWORD = createField(DSL.name("password"), SQLDataType.VARCHAR.nullable(false), this, "");

    /**
     * The column <code>credential.user.is_enabled</code>.
     */
    public final TableField<UserRecord, Boolean> IS_ENABLED = createField(DSL.name("is_enabled"), SQLDataType.BOOLEAN, this, "");

    /**
     * The column <code>credential.user.is_account_non_expired</code>.
     */
    public final TableField<UserRecord, Boolean> IS_ACCOUNT_NON_EXPIRED = createField(DSL.name("is_account_non_expired"), SQLDataType.BOOLEAN, this, "");

    /**
     * The column <code>credential.user.is_credentials_non_expired</code>.
     */
    public final TableField<UserRecord, Boolean> IS_CREDENTIALS_NON_EXPIRED = createField(DSL.name("is_credentials_non_expired"), SQLDataType.BOOLEAN, this, "");

    /**
     * The column <code>credential.user.is_account_non_locked</code>.
     */
    public final TableField<UserRecord, Boolean> IS_ACCOUNT_NON_LOCKED = createField(DSL.name("is_account_non_locked"), SQLDataType.BOOLEAN, this, "");

    /**
     * The column <code>credential.user.firstname</code>.
     */
    ...
    /**
     * The column <code>credential.user.lastname</code>.
     */
    ...
    /**
     * The column <code>credential.user.email</code>.
     */
    public final TableField<UserRecord, String> EMAIL = createField(DSL.name("email"), SQLDataType.VARCHAR(255).nullable(false), this, "");

    /**
     * The column <code>credential.user.authorities</code>.
     */
    public final TableField<UserRecord, Authority[]> AUTHORITIES = createField(DSL.name("authorities"), SQLDataType.VARCHAR.nullable(false).asEnumDataType(Authority.class).array(), this, "");
    ...
    /**
     * Create an aliased <code>credential.user</code> table reference
     */
    ...
    /**
     * Create a <code>credential.user</code> table reference
     */
    public User() {
